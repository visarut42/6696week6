...
<body>
  ...
  <div class="row mb-3">
    <label for="inputPassword3" class="col-sm-2">ซีพียู</label>
    <div class="col-sm-3">
  ...
  <div class="row mb-3">
    <label for="inputPassword3" class="col-sm-2">ความจุแบตเตอร์รี่</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="inputPassword3" name="Batteries">
 </div><br><br>
 ...
 <div class="row mb-3">
    <label for="inputPassword3" class="col-sm-2">รุ่น</label>
    <div class="col-sm-3">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // ทำการเพื่อมข้อมูล
    try {
        $sql = "INSERT INTO smartphone  (Brand, CPU, Batteries, Colors, Model)
        VALUES ('$Brand', '$CPU', '$Batteries', '$Colors', '$Model')";
